...
export default {
  ...
  proxy: {
    ...
    '/api/mobile': { target: process.env.NODE_ENV == 'development' ? 'https://webapi.resaa.net' : 'http://api.bsn.local' },
    '/api/messagecallback': { target: process.env.NODE_ENV == 'development' ? 'https://webapi.resaa.net' : 'http://api.bsn.local' },
  },
  serverMiddleware: [
    {
