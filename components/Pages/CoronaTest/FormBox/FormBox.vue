  ...
  <section id="FormBox">
    <div class="wrapper">
      ...
      <template v-else>
        ...
        <p>برای انجام تست کرونا در منزل لازم است فرم زیر را پر کنید. پس از پرداخت هزینه ی تست، پشتیبانی در کمتر از ۵ ساعت در بازه ی ۹ الی ۲۱ با شما تماس خواهد گرفت و برای گرفتن تست با شما هماهنگ خواهد کرد.</p>
      </template>
