  ...
  <section id="FirstFord">
    <div class="wrapper">
      <div class="text">
        ...
        <p>اگر ساکن تهران هستید همین امروز می توانید در منزل خود تست کرونا دهید. متخصصین آزمایشگاه برای تست آنتی بادی یا تست PCR در کمتر از ۲۴ ساعت در محل خودتان نمونه می گیرند و نتیجه را در سریع ترین زمان به صورت آنلاین به شما اعلام می کنند.</p>
