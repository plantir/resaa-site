...
<template>
  <section>
    <v-card class="call-wrapper">
      <div class="title flex-60 mb-75">همین حالا با پزشک تماس بگیرید</div>
      <div class="flex-40 flex-end mb-75">
        <span class="title mb-0">هزینه هر دقیقه گفتگو با پزشک :</span>
        <span class="price">{{3000 | currency | persianDigit}} تومان</span>
      </div>
      <div
        class="description flex-60"
