  ...
  <section>
    <div class="wrapper" v-if="result">
      <div v-if="result.payment_status == 'paid'">
        ...
        <p>کاربر گرامی درخواست در کمتر از ۵ ساعت (در بازه ی ۱۰ الی ۲۱) بررسی شده و جهت مراجعه و نمونه گیری با شما تماس گرفته می شود. جهت پیگیری سفارش خود کافیست از بالای صفحه تست کرونا پیگیری تست را انتخاب کرده و در صفحه جدید شماره موبایل و کد ملی خود را وارد نمایید.</p>
